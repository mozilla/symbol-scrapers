...
get_package_urls() {
  ...
  find . -name "index.html*" -exec grep -o "${url}/${main_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${url}/${universe_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${url}/${multiverse_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${url}/${restricted_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${ddeb_url}/${main_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${ddeb_url}/${universe_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${ddeb_url}/${multiverse_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${ddeb_url}/${restricted_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1

  if [ -n "${alt_url}" ]; then
    find . -name "index.html*" -exec grep -o "${alt_url}/${main_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
    find . -name "index.html*" -exec grep -o "${alt_url}/${universe_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
    find . -name "index.html*" -exec grep -o "${alt_url}/${multiverse_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
    find . -name "index.html*" -exec grep -o "${alt_url}/${restricted_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.d.*eb\"" {} \; | cut -d'"' -f1
  fi
