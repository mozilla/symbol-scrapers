...
get_package_urls() {
  ...
  find . -name "index.html*" -exec grep -o "${url}/${main_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${url}/${non_free_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${url}/${contrib_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${ddeb_url}/${main_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${ddeb_url}/${non_free_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1
  find . -name "index.html*" -exec grep -o "${ddeb_url}/${contrib_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1

  if [ -n "${alt_url}" ]; then
    find . -name "index.html*" -exec grep -o "${alt_url}/${main_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1
    find . -name "index.html*" -exec grep -o "${ddeb_alt_url}/${main_path}/\(${package_name}\|${dbg_package_name}-dbg\|${dbgsym_package_name}-dbgsym\)_.*_${arch_escaped_regex}.deb\"" {} \; | cut -d'"' -f1
  fi
